...
<el-col :span="10">
  ...
  <el-form-item label="Phone: " required>
    <el-col :span="8">
     <el-select v-model="ruleForm.countryCode" placeholder="Country" clearable>
  ...
  <el-form-item label="Code: " prop="code">
    <el-col :span="12">
    <el-input v-model="ruleForm.code" placeholder="Verification code"></el-input>
    </el-col>
    <el-col :span="10">
  ...
  <el-form-item v-if="false" >
    ...
    <el-button type="primary" >Create</el-button>
      ...
      <div v-if="false" class="bottom">By signing up, you agree to the <br />
